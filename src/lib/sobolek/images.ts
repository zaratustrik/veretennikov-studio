...
// Эскизы 2D-версии персонажа (поисковый этап, тёмный фон из генераций)
export const IMAGES_2D = {
  neutral: {
    name: "d2-neutral",
    widths: [480, 800],
    width: 800,
    height: 1200,
    alt: "2D-эскиз Соболька: нейтральная поза в полный рост, упрощённый векторный стиль",
  },
  wave: {
    name: "d2-wave",
    widths: [480, 800],
    width: 800,
    height: 1200,
    alt: "2D-эскиз Соболька: приветствие — персонаж машет лапой с подушечками",
  },
  thumbs: {
    name: "d2-thumbs",
    widths: [480, 800],
    width: 800,
    height: 1200,
    alt: "2D-эскиз Соболька: жест «отлично»",
  },
  open: {
    name: "d2-open",
    widths: [480, 800],
    width: 800,
    height: 1200,
    alt: "2D-эскиз Соболька: открытый жест ладонью — персонаж представляет содержимое",
  },
  head: {
    name: "d2-head",
    widths: [480, 800],
    width: 800,
    height: 1200,
    alt: "2D-эскиз головы Соболька анфас в кепке",
  },
  hands: {
    name: "d2-hands",
    widths: [480, 800],
    width: 800,
    height: 1200,
    alt: "Лист вариантов кистей 2D-Соболька: ладонь с подушечками, расслабленная, тыльная сторона, открытая",
  },
} as const satisfies Record<string, SobolekImage>;
