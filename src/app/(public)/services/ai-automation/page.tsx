...
const FAQ = [
  ...
  {
    question: "Как формируется стоимость AI-проекта?",
    answer:
      "Зависит от объёма данных, числа интеграций и сложности интерфейса. Сначала проводим короткий анализ процесса и собираем прототип на ваших данных — после этого видна реальная сложность и можно зафиксировать смету. Это безопаснее, чем считать «вслепую» по требованиям из ТЗ.",
  },
  {
