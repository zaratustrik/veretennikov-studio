...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Зависит от состава работ: от 700 тысяч ₽ за компактный продуктовый ролик до 2,5 млн ₽ за полнометражный фильм с большой съёмкой и сложным VFX. Точную смету собираем после брифа и согласования сценарной структуры.",
  },
  {
