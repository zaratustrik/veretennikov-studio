...
const FAQ = [
  ...
  {
    question: "Сколько стоит интерактивный стенд?",
    answer:
      "От 800 тысяч ₽ за компактный стенд с синхронными экранами и mini app до 5 млн ₽ за крупный стенд с AI-консультантом, видеостеной, кастомным железом и съёмкой контента. Точную смету собираем после брифа и согласования сценария.",
  },
  {
