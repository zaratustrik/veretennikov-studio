        ...
        <div className="mx-auto px-5 md:px-8" style={{ maxWidth: "var(--content-max)" }}>
          <div className="grid lg:grid-cols-[1.2fr_1fr] gap-8 lg:gap-16 items-center">
            <div>
              ...
              >
                Корпоративные программы по ИИ
              </h2>
              <p className="text-[var(--ink-2)] leading-[1.65] max-w-[56ch]" style={{ fontSize: "15px" }}>
                Практические программы для руководителей, подразделений
                и отраслевых организаций. На выходе — не сертификат, а список
                процессов организации, с которых имеет смысл начать.
              </p>
            </div>
            <Link
              href="/programs"
