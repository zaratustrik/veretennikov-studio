...
const PRICING: {
  ...
  {
    title: "Иллюстрации 3D-версии",
    desc: "Параллельный трек: набор фирменных иллюстраций на основе утверждённого 3D-образа — сцены для разделов сайта, обложки для соцсетей и презентаций, тематические изображения под задачи платформы. Подготовка в web- и печатных форматах.",
    result: "Стартовый набор 3D-иллюстраций",
    hours: 8,
    price: "20 000",
  },
  {
      ...
      <section id="predlozhenie" className="scroll-reveal border-t border-[var(--sb-line)] bg-[var(--sb-teal-tint)]/50">
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <p className="mt-5 max-w-2xl text-[15px] leading-relaxed text-[var(--sb-gray)]">
            Смета охватывает обе версии персонажа: производство 2D-помощника и
            стартовый набор иллюстраций на основе 3D-образа. Ставка — 2 500 ₽/час.
            Работа идёт поэтапно: каждый этап завершается показом и утверждением,
            в стоимость включены две итерации правок. Ответы вашей анкеты учтены
            в составе работ.
          </p>
