...
const CHARACTER_QUALITIES = [
  ...
  "Дружелюбный, но не чрезмерно детский — понятен и детям, и старшей аудитории",
  "Спортивный и энергичный — в характере Движения",
  "Современный, но не карикатурный; узнаваем именно как соболь",
];

const VISUAL_FEATURES = [
  "Молочно-белая шерсть, тёмный кончик пушистого хвоста",
  "Бирюзово-голубые глаза, округлая мордочка",
  "Фирменная бело-бирюзовая одежда с геометрией айдентики",
  "Хорошо читаемый силуэт — работает и в статике, и в анимации",
];
...
const PRICING: {
  ...
  },
  {
    ...
    desc: "Исходники Illustrator и After Effects, Lottie-файлы для сайта, исходники иллюстраций, видео-превью, краткое руководство по использованию и созданию новых анимаций.",
...
export default function SobolekPage() {
  return (
    <main className="overflow-x-clip">
      ...
      {/* 2. Утверждённый образ — краткая фиксация */}
      <section id="ponimanie" className="scroll-reveal border-t border-[var(--sb-line)] bg-white/60">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
          <div className="mx-auto w-full max-w-105 lg:max-w-none">
            ...
            <p className="mt-3 text-center text-sm text-[var(--sb-gray)]">
              Утверждённый образ: Соболёк с планшетом
            </p>
          </div>
          <div>
            <Eyebrow>Что уже зафиксировано</Eyebrow>
            <SectionTitle>Утверждённый образ — основа всего дальнейшего</SectionTitle>
            <p className="mt-5 text-[15px] leading-relaxed text-[var(--sb-gray)]">
              Соболёк — не разовая иллюстрация, а постоянный персонаж платформы:
              один облик и характер во всех носителях. Ниже — то, что мы считаем
              неизменяемым в любой новой версии персонажа.
            </p>
            <div className="mt-7 grid gap-6 sm:grid-cols-2">
              <div>
                <h3 className="sb-heading mb-3 text-base font-bold">Характер</h3>
              ...
              <div>
                <h3 className="sb-heading mb-3 text-base font-bold">Визуальный канон</h3>
                <ul className="space-y-2.5">
      ...
      <section className="scroll-reveal border-t border-[var(--sb-line)] bg-white/60">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <p className="mt-5 max-w-3xl text-[15px] leading-relaxed text-[var(--sb-gray)]">
            ...
            как отдельные элементы. Это задел под будущее полноценное 3D-производство —
            когда понадобятся произвольные позы, объёмная анимация и рендеры под
            конкретные задачи.
          </p>
        ...
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl bg-[var(--sb-cream)] p-6 sm:p-8">
              ...
              <ul className="space-y-3">
                ...
                <Check>Видеоролики и заставки</Check>
          ...
          <div className="mt-8 max-w-4xl rounded-2xl border border-[var(--sb-line)] bg-white/70 p-6 sm:p-7">
            ...
            <p className="text-[14px] leading-relaxed text-[var(--sb-gray)]">
              Технологии WebGL позволяют показывать объёмную сцену прямо на странице —
              это эффектно, но у подхода есть цена. Модель с текстурами и библиотека
              просмотра — это единицы мегабайт, которые нужно загрузить до первого
              показа, и постоянная нагрузка на процессор и батарею: на недорогих
              телефонах анимация идёт неровно, а на слабых устройствах браузер может
              и вовсе отключить ускоренную графику. Lottie-анимация свободна от этих
              ограничений: файл весит как одна фотография, масштабируется без потери
              качества и не задерживает загрузку страницы — что важно и для
              пользователей, и для поисковых систем. Формат создан командой Airbnb
              и поддерживается всеми современными браузерами.
            </p>
      ...
      <section className="scroll-reveal border-t border-[var(--sb-line)] bg-white/60">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <p className="mt-8 max-w-3xl text-[14px] leading-relaxed text-[var(--sb-gray)]">
            В чистовой векторной версии детали будут выровнены по паспорту персонажа —
            единый нос, кисти, усы и фирменная палитра, плюс логотип Движения
            на футболке.
          </p>
        </div>
      </section>
      ...
      <section id="predlozhenie" className="scroll-reveal border-t border-[var(--sb-line)] bg-[var(--sb-teal-tint)]/50">
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <SectionTitle>Состав и стоимость работ</SectionTitle>
          <p className="mt-5 max-w-2xl text-[15px] leading-relaxed text-[var(--sb-gray)]">
            Смета охватывает оба трека: производство анимированного 2D-помощника
            и набор иллюстраций на основе 3D-образа. Ставка — 2 500 ₽/час.
            Работа идёт поэтапно: каждый этап завершается показом и утверждением,
            в стоимость включены две итерации правок.
          </p>
          <div className="mt-6 max-w-2xl rounded-2xl border border-[var(--sb-teal-soft)] bg-white/70 p-5 text-[14px] leading-relaxed text-[var(--sb-gray)]">
            <p className="mb-2 font-semibold text-[var(--sb-brown)]">
              Как это соотносится с вашей анкетой
            </p>
            <p>
              В анкете вы отметили полный цикл 3D-производства — мастер-модель,
              скелетный риг, лицевую мимику и анимации. Это большой отдельный проект.
              Мы предлагаем начать с того, что быстрее даёт видимый результат на
          ...
          <ul className="mt-8 space-y-3">
            ...
            <Check>
              Срок производства — 5–6 недель работы; с учётом согласований
              ориентируемся на два месяца
            </Check>
            <Check>
              По завершении передаются редактируемые исходники и исключительные
              права на использование и дальнейшее развитие персонажа
            </Check>
            <Check>
              Дальнейшее развитие — по запросу: дополнительный анимационный цикл
              4–6 часов, новые эмоции и позы 1–2 часа за позицию, сезонные
              комплекты одежды — отдельной оценкой
            </Check>
            <Check>
            ...
            {[
              {
                ...
                text: "Достаточно ответа в любом удобном канале.",
              },
              {
                title: "Передать брендбук и логотип, согласовать 2D-канон",
                text: "Нужен брендбук Движения и логотип в векторе — вы отметили в анкете, что он обязателен на футболке персонажа. Дальше один короткий показ: лист сверки 2D-стиля с утверждённым образом.",
              },
              {
                title: "Производство",
                text: "Первый живой Соболёк появляется на сайте примерно через месяц после старта — с учётом времени на согласования. Далее пакет анимаций, иллюстрации и передача материалов.",
              },
            ].map((step, i) => (
              <li
                key={step.title}
