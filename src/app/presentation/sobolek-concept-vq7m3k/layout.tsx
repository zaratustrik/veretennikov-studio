...
export const metadata: Metadata = {
  title: "Соболёк — маскот Движения: план воплощения",
  description:
    "Утверждённый образ маскота и предложение по его воплощению для платформы «Урал: за медицину здорового долголетия».",
  robots: {
    index: false,
    follow: false,
    nocache: true,
