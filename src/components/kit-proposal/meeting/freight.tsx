...
export function MergedPool() {
  ...
  return (
    <svg viewBox="0 0 1100 358" className="kdm-svg" role="img"
      ...
      {/* Что мешает — рядом с выигрышем, а не отдельным разговором */}
      <text x="0" y="322" className="kdm-t-sub" fill={WARN}>
        Мешают: география · время · вместимость · тип кузова · график терминала · договорные условия.
      </text>

      {/* Дальний горизонт — одной строкой, чтобы не спорить за внимание */}
      <text x="0" y="350" className="kdm-t-sub" fill="#6F7F93">
