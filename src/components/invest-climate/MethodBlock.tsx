...
const METHOD_POINTS: { title: string; text: string }[] = [
  ...
  },
  {
    ...
    text: "Каждая из 43 строк проанализирована отдельно: текст мероприятия, КПЭ, сроки, ответственные, связь с критерием показателя.",
  },
  {
  ...
  {
    title: "Аудит КПЭ",
    text: "Ключевые показатели эффективности (КПЭ) классифицированы на показатели результата и показатели формальной активности (документы, встречи, публикации); составлен словарь КПЭ.",
  },
  {
    title: "Сопоставление с практиками других регионов и стран",
  ...
  {
    title: "Предложения с условиями пересмотра",
    text: "Новая редакция (30 строк, 5 блоков) и дополнительные меры содержат КПЭ результата, исходные и целевые значения, владельцев, горизонты и условия пересмотра при невыполнении.",
  },
];
