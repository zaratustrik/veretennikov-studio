...
journey = [
    {"id": "interest", "title": "Первичный интерес", "services": ["Инвестпортал (RU/EN/CN)", "Презентация региона"], "gaps": ["Портал не ведёт к действию — нет явного первого шага"], "itemIds": [37, 38], "proposals": ["Целевое продвижение после качества данных"]},
